try{
(()=>{var Xo=Object.defineProperty;var w=(o,e)=>()=>(o&&(e=o(o=0)),e);var Yt=(o,e)=>{for(var t in e)Xo(o,t,{get:e[t],enumerable:!0})};var d=w(()=>{});var g,p=w(()=>{g={NODE_ENV:"production",NODE_PATH:[],STORYBOOK:"true",PUBLIC_URL:"."}});var h=w(()=>{});var rs,os,ns,Zt,is,ss,as,ls,cs,us,ds,ps,hs,fs,Gt,ms,gs,vs,ys,bs,xs,_s,ws,Te,$s,ke,Es,Ss,re,As,Ps,Cs,Ms,I,Ts,ks,Os,Xt,Ns,Rs,Bs,js,Ls,Is,Fs,Hs,Us,zs,Ds,qt,Vs,Ys,Ws,Zs,Gs,Xs,qs,Ks,Js,Qs,ea,ta,ra,oa,na,ia,sa,U=w(()=>{d();p();h();rs=__STORYBOOK_COMPONENTS__,{A:os,ActionBar:ns,AddonPanel:Zt,Badge:is,Bar:ss,Blockquote:as,Button:ls,ClipboardCode:cs,Code:us,DL:ds,Div:ps,DocumentWrapper:hs,ErrorFormatter:fs,FlexBar:Gt,Form:ms,H1:gs,H2:vs,H3:ys,H4:bs,H5:xs,H6:_s,HR:ws,IconButton:Te,IconButtonSkeleton:$s,Icons:ke,Img:Es,LI:Ss,Link:re,ListItem:As,Loader:Ps,OL:Cs,P:Ms,Placeholder:I,Pre:Ts,ResetWrapper:ks,ScrollArea:Os,Separator:Xt,Spaced:Ns,Span:Rs,StorybookIcon:Bs,StorybookLogo:js,Symbols:Ls,SyntaxHighlighter:Is,TT:Fs,TabBar:Hs,TabButton:Us,TabWrapper:zs,Table:Ds,Tabs:qt,TabsState:Vs,TooltipLinkList:Ys,TooltipMessage:Ws,TooltipNote:Zs,UL:Gs,WithTooltip:Xs,WithTooltipPure:qs,Zoom:Ks,codeCommon:Js,components:Qs,createCopyToClipboardFunction:ea,getStoryHref:ta,icons:ra,interleaveSeparators:oa,nameSpaceClassNames:na,resetComponents:ia,withReset:sa}=__STORYBOOK_COMPONENTS__});var da,pa,ha,fa,ma,ga,va,ya,ba,xa,_a,wa,O,$a,Ea,Sa,Aa,f,Pa,Ca,Ma,Ta,ka,Oa,Na,L=w(()=>{d();p();h();da=__STORYBOOK_THEMING__,{CacheProvider:pa,ClassNames:ha,Global:fa,ThemeProvider:ma,background:ga,color:va,convert:ya,create:ba,createCache:xa,createGlobal:_a,createReset:wa,css:O,darken:$a,ensure:Ea,ignoreSsrWarning:Sa,isPropValid:Aa,jsx:f,keyframes:Pa,lighten:Ca,styled:Ma,themes:Ta,typography:ka,useTheme:Oa,withTheme:Na}=__STORYBOOK_THEMING__});var Ne={};Yt(Ne,{Children:()=>Jo,Component:()=>tt,Fragment:()=>S,Profiler:()=>Qo,PureComponent:()=>en,StrictMode:()=>tn,Suspense:()=>rt,__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:()=>rn,cloneElement:()=>on,createContext:()=>nn,createElement:()=>sn,createFactory:()=>an,createRef:()=>ln,default:()=>Ko,forwardRef:()=>cn,isValidElement:()=>un,lazy:()=>ot,memo:()=>dn,startTransition:()=>pn,unstable_act:()=>hn,useCallback:()=>F,useContext:()=>fn,useDebugValue:()=>mn,useDeferredValue:()=>gn,useEffect:()=>N,useId:()=>vn,useImperativeHandle:()=>yn,useInsertionEffect:()=>bn,useLayoutEffect:()=>xn,useMemo:()=>W,useReducer:()=>_n,useRef:()=>wn,useState:()=>T,useSyncExternalStore:()=>$n,useTransition:()=>En,version:()=>Sn});var Ko,Jo,tt,S,Qo,en,tn,rt,rn,on,nn,sn,an,ln,cn,un,ot,dn,pn,hn,F,fn,mn,gn,N,vn,yn,bn,xn,W,_n,wn,T,$n,En,Sn,R=w(()=>{d();p();h();Ko=__REACT__,{Children:Jo,Component:tt,Fragment:S,Profiler:Qo,PureComponent:en,StrictMode:tn,Suspense:rt,__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:rn,cloneElement:on,createContext:nn,createElement:sn,createFactory:an,createRef:ln,forwardRef:cn,isValidElement:un,lazy:ot,memo:dn,startTransition:pn,unstable_act:hn,useCallback:F,useContext:fn,useDebugValue:mn,useDeferredValue:gn,useEffect:N,useId:vn,useImperativeHandle:yn,useInsertionEffect:bn,useLayoutEffect:xn,useMemo:W,useReducer:_n,useRef:wn,useState:T,useSyncExternalStore:$n,useTransition:En,version:Sn}=__REACT__});var it,ce,Pn,Cn,Mn,Kt,Jt,Qt,Re=w(()=>{d();p();h();R();L();U();it=function(o,e){return Object.defineProperty?Object.defineProperty(o,"raw",{value:e}):o.raw=e,o},ce=function(o){var e=o.config,t=o.defer,r=t===void 0?!1:t,n=T(r?void 0:e.url),i=n[0],s=n[1],c=T(!1),a=c[0],l=c[1];return N(function(){if(r){var u=requestAnimationFrame(function(){s(e.url)});return function(){return cancelAnimationFrame(u)}}},[r,e.url]),N(function(){l(!1)},[i]),f("div",{css:Pn},!a&&f(I,{css:Cn},"Loading..."),f("iframe",{css:Mn,src:i,allowFullScreen:e.allowFullscreen,onLoad:function(){return l(!0)}}))},Pn=O(Kt||(Kt=it([`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
`)}},go=o=>[Math.trunc(255*o.r),Math.trunc(255*o.g),Math.trunc(255*o.b)],Qn=o=>{let[e,t,r]=go(o);return"#"+((1<<24)+(e<<16)+(t<<8)+r).toString(16).slice(1)},Rt=({property:o,value:e})=>`${o}: ${e};`});var ei,Bt,yo,ti,ri,bo,xo=w(()=>{d();p();h();D();Ot();vo();ei=function(o,e,t,r){function n(i){return i instanceof t?i:new t(function(s){s(i)})}return new(t||(t=Promise))(function(i,s){function c(u){try{l(r.next(u))}catch(m){s(m)}}function a(u){try{l(r.throw(u))}catch(m){s(m)}}function l(u){u.done?i(u.value):n(u.value).then(c,a)}l((r=r.apply(o,e||[])).next())})},Bt=o=>ei(void 0,void 0,void 0,function*(){yield navigator.clipboard.writeText(o)}),yo=({node:o,onClose:e})=>{if(!o)return null;let t=new We(o),r=n=>n.stopPropagation();return E`
    <div
  ...
  `},ti=o=>{let e=()=>Bt(o.getStyleSheet()),t=o.getStyles();return E`<div class="inspector-section">
  ...
  </div>`},ri=o=>{let{property:e,value:t,color:r}=o,n=null;switch(e){case"background":case"fill":case"border":case"box-shadow":case"color":n=E`<span
        class="color-preview"
...
`});var ii,Eo,So,Ao=w(()=>{d();p();h();ii=[{gte:31536e6,divisor:31536e6,unit:"year"},{gte:2592e6,divisor:2592e6,unit:"month"},{gte:6048e5,divisor:6048e5,unit:"week"},{gte:864e5,divisor:864e5,unit:"day"},{gte:36e5,divisor:36e5,unit:"hour"},{gte:6e4,divisor:6e4,unit:"minute"},{gte:3e4,divisor:1e3,unit:"seconds"},{gte:0,divisor:1,text:"just now"}],Eo=o=>(typeof o=="object"?o:new Date(o)).getTime(),So=(o,e=Date.now(),t=new Intl.RelativeTimeFormat(void 0,{numeric:"auto"}))=>{let n=Eo(e)-Eo(o),i=Math.abs(n);for(let s of ii)if(i>=s.gte){let c=Math.round(Math.abs(n)/s.divisor),a=n<0,l=s.unit;return l?t.format(a?c:-c,l):s.text}}});var Po,Co,Mo=w(()=>{d();p();h();D();Ot();Ao();Po=B`
  .figma-footer {
    flex: 0;
    z-index: calc(var(--z-index) + 1);
