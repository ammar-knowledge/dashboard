        ...
        <Container>
            <form className='flex flex-row items-ceneter w-full'>
                ...
                <Box className={classes.rowContainer}>
                    ...
                    <div style={{ backgroundColor: '#C7D2F0', display: 'flex', height: 580, width: 480, alignItems: 'center', justifyContent: 'start', paddingTop: 20, paddingLeft: 30, paddingRight: 30, flexDirection: 'column' }}>
