...
const Dropdowns = ({ skills, handleRemovSkillFields, hiddenSubSkill, setHiddenSubSkill, skillsData, setSkillsData,skillPayload,setSkillPayload }) => {
    const { id } = skills
    ...
    const handleSubSkillChange = (subSkill) => {
        ...
        const newArr = [...skillPayload,newSkill]
        setSkillPayload(newArr)
        console.log(newArr)
    };
