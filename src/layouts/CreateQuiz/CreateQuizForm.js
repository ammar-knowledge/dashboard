...
const CreateQuizForm = () => {
    ...
    const createQuiz = () => {
        ...
        const interactiveId = getInteractiveTypeId('quiz')
        let duration = 0
        ...
        if (title !== '' || description !== '' || duration > 0) {
            const payload = {
                "interactive": {
                    "title": title,
                    "interactive_type_id": interactiveId,
            ...
            setSnackbarMessage("Please add title description and duration ")
        ...
        <div>
            ...
            <div style={{ padding: '20px', display: 'flex', flexDirection: 'column', justifyContent: 'space-around' }}>
                <div className={classes.header}>
                    <div className={classes.title}>Create a Quiz</div>
                </div>
                        ...
                        <div style={{ backgroundColor: "#9BA0EF", width: "450px", height: "525px", padding: 20, borderRadius: "8px" }}>
                            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'start' }}>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: "100%" }}>
                                    {
                                        questions && questions.length > 0 && questions.map((question, index) => <QuizQuestion key={index} added={true} question={question} removeQuestionFromQuiz={removeQuestionFromQuiz} AddQuestionToQuiz={AddQuestionToQuiz} />)
                                    }
                                </div>
                            </div>
                        </div>
                ...
                <div style={{ width: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    <div className={classes.buttonGroup}>
                        ...
                        <Button variant="contained" onClick={createQuiz} className={classes.saveButton}>
                            Save
                        </Button>
                    </div>
                </div>
